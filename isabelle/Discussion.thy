...
For reasons of time, I did not attempt to prove the reduction with this altered mapping, but I am convinced that it is possible.\<close>
...
\footnote{see \code{\href{https://www.isa-afp.org}{isa-afp.org}}}

...
text \<open>Propositions are terms of Boolean type. Propositions can be given using any of the commands \<open>proposition\<close>, \<open>lemma\<close>, \<open>theorem\<close>, \<open>corollary\<close>, and require a proof.
